...
export const managers = [
    {
      ...
      "favoritePlayer": 88, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
    ...
    },
   {
      ...
      },
    {
      ...
      "photo": "/managers/Chris White.jpeg", // square ratio recommended (no larger than 500x500)
